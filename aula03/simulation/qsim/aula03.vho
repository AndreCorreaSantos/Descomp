...
SIGNAL \DECODER1|saida[1]~1_combout\ : std_logic;
SIGNAL \DECODER1|saida[2]~2_combout\ : std_logic;
...
SIGNAL \DECODER1|ALT_INV_saida[1]~1_combout\ : std_logic;
...
\DECODER1|ALT_INV_saida[1]~1_combout\ <= NOT \DECODER1|saida[1]~1_combout\;
...
\DECODER1|saida[1]~1\ : cyclonev_lcell_comb
-- Equation(s):
-- \DECODER1|saida[1]~1_combout\ = ( !\PC|DOUT\(0) & ( !\PC|DOUT\(1) & ( !\PC|DOUT[2]~DUPLICATE_q\ ) ) )
...
PORT MAP (
	...
	combout => \DECODER1|saida[1]~1_combout\);

-- Location: LABCELL_X1_Y19_N48
\DECODER1|saida[2]~2\ : cyclonev_lcell_comb
-- Equation(s):
-- \DECODER1|saida[2]~2_combout\ = ( \PC|DOUT[1]~DUPLICATE_q\ & ( \PC|DOUT[0]~DUPLICATE_q\ & ( !\PC|DOUT\(2) ) ) ) # ( !\PC|DOUT[1]~DUPLICATE_q\ & ( \PC|DOUT[0]~DUPLICATE_q\ & ( !\PC|DOUT\(2) ) ) ) # ( \PC|DOUT[1]~DUPLICATE_q\ & ( !\PC|DOUT[0]~DUPLICATE_q\ & 
...
PORT MAP (
	...
	dataf => \PC|ALT_INV_DOUT[0]~DUPLICATE_q\,
	combout => \DECODER1|saida[2]~2_combout\);
...
PORT MAP (
	...
	clrn => \DECODER1|ALT_INV_saida[1]~1_combout\,
	ena => \DECODER1|saida[2]~2_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \REGA|DOUT\(0));
...
-- Equation(s):
-- \DECODER1|saida[0]~0_combout\ = (!\PC|DOUT\(2) & ((\PC|DOUT[0]~DUPLICATE_q\) # (\PC|DOUT[1]~DUPLICATE_q\)))
